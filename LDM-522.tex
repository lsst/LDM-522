...
\subsubsection{Verification Metrics Code}
\label{sec:qaVerify}
\begin{itemize}

\item During Construction, progress towards meeting DM subsystem requirements revolve around the Key Performance Metrics (KPMs) outlined in \citeds{LDM-240}. SDQA implements code to calculate these KPMs. Consult \citeds{LDM-502} for a list of those metrics and how (and by whom and on what) they will be calculated.
